...
ActiveRecord::Schema.define(version: 0) do
  ...
  add_foreign_key 'course_teachers', 'courses', column: 'course_id', primary_key: 'course_id', name: 'fk_courses_has_teachers_courses1', on_update: :cascade, on_delete: :cascade
  add_foreign_key 'course_teachers', 'teachers', column: 'teacher_id', primary_key: 'teacher_id', name: 'fk_courses_has_teachers_teachers1', on_update: :cascade, on_delete: :cascade
